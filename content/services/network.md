...
### ゲスト用無線LAN
学会や研究会などの際，学外者が利用可能な無線LANを提供します。
   - 認証方式：WPA2
   - [ゲスト用無線LAN 申請](https://forms.office.com/r/VPk9yiYniX)
   - 申請する場所で接続できます。
   - 接続時には，利用規約への同意が必要です。

### 802.1x非対応デバイス向け 無線LAN Fuchsia
INDIGOの認証方式に対応しない機器を，INDIGOと同じネットワークに接続します。
原則として，設置場所が固定されているデバイスを対象とします。
   - SSID: Fuchsia
   - 認証方式：WPA2
   - [802.1x非対応デバイス向け無線LAN 申請](https://forms.cloud.microsoft/r/qiTyTWLMxF)
   - 申請する場所で接続できます。
   - 附属学校では，INDIGO または GIGA ネットワークへ接続できます。
   - プロキシの設定は，必要に応じて行ってください。非対応の場合は，情報基盤センターへご相談ください。


### プロキシを利用しない無線LANルータ貸出サービス
試験的に提供しています。  
...
[学外からの接続 申請](https://forms.office.com/r/jfA428Fns5)
