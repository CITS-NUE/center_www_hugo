...
---
学術認証フェデレーション(GakuNin)とは，学術e-リソースを利用する大学，学術e-リソースを提供する機関・出版社等から構成された連合体（フェデレーション）のことです。  
各機関がフェデレーションで定めたポリシーを信頼しあうことで，相互に認証連携の実現を可能とします。　　
 GakuNinに参加している他大学や商用のサービス(SP)と認証連携を行うことによって，鳴門教育大学ユーザIDとそのパスワードを用いた認証を可能とする環境を実現することができます。
...
1. eduroamに参加している学外機関を訪問した際  
本学の　ユーザID(職員番号)@naruto-u.ac.jp のアカウントで，訪問先機関の無線LAN eduroam に接続します。
2. eduroamに参加している学外機関所属者(学外者)が來学した際  
本学の無線LAN edroam に接続します。
